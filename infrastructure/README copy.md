...
Then for the confidentiality form please upload the file with name "Confidentiality_Form.pdf" (EXACT) - TODO
...
#### 3.5) Cognito first admin - LEFT OFF
...
```powershell
aws cloudformation create-stack --region us-east-1 --stack-name bhchp-ecs --template-body "file://./05-ecs-fargate.yml" --parameters "file://./params/05-ecs-fargate.json"
```
